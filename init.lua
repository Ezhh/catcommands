...
-- Cursed with eternal daylight
	...
	--The string.len prevents server crash if a person includes two decimals. I know there's a better solution, but learning pattern matching looks painful.
		if string.len(value) > 2 or value == nil or value == "" or
		...
		if tonumber(value) < .5 then
					player:set_attribute("blinded", value)
	...
	if string.len(speed) > 2 or speed == nil or speed == "" or
